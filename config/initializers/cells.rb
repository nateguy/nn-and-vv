# Code from gem `cells-haml`
# https://github.com/trailblazer/cells-haml/blob/master/lib/cell/haml.rb
# That gem only support `cells` 4.x
require 'cells'
require 'tilt/haml'
...
module Cell
  ...
  # This is NOT usable for cells 3.x
